...
public class Ex23_Calendar {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		//변수 선언
		// - 보통 변수의 초깃값은 해당 변수가 가질 수 없는 값 > 실패하더라도 피해가 적거나 발견하기 쉬워서
...
//		output(year, month);
	...
	public static int getDayOfWeek(int year, int month) {
		...
		//서기 1년 1월 1일 ~ yaer년 month월 1일까지 총 며칠?
	...
	public static int getLastDay(int year, int month) { //100
		...
		switch(month) {
			...
			case 10:
			case 12:
				return 31;//return문: 메소드를 종료하는 역할(break유사) + 값 반환 //break안씀
			case 4:
			case 6:
			case 9:
			case 11:
