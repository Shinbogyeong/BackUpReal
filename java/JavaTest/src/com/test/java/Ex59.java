...
public class Ex59 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Integer.toHexString(225));//ff ->16진수
		System.out.println(Integer.toOctalString(10)); //12 -> 	10진수
		...
		System.out.println(s1.charAt(0) > s2.charAt(0));//값 비교 -> 문자코드 값 비교
		...
		System.out.println(compareString(s1, s2));//앞이크다(1), 뒤가 크다(-1), 같다(0)
