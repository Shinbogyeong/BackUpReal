...
public class Ex71_File {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 1. 텍스트 입출력
		 	...
		 	- 메모장
		 	- 수업
		 	- "홍길동" -> (변환) -> 10101010101010 //파일쓰기
		 	- 10101010101010 -> (변환) -> "홍길동" //파일쓰기
	...
	private static void m6() {
		...
		//쓰기
		//FileOutputStream -> FileWriter -> BufferedWriter//뒤에 두개 씀
		//FileInputStream -> FileReader -> BufferedReader //뒤에꺼만 씀 거의
...
//			int code = reader.read();//코드로 나옴
//			System.out.println((char)code);
//			
//			code = reader.read();//코드로 나옴
//			System.out.println((char)code);
//			
//			code = reader.read();//코드로 나옴
//			System.out.println((char)code);
	...
	private static void m3() {
		...
		try {
			...
			//FileOutputStream -> FileWriter
			//FileWriter writer = new FileWriter("C:\\class\\java\\file\\data2.txt");
			FileWriter writer = new FileWriter("C:\\class\\java\\file\\data2.txt", true);//append모드
...
//			System.out.println(code);
	...
	private static void m1() {
		...
		//쓰기
		// - 바이트 단위 쓰기
		// - 1byte단위만 저장한다.(한글 불가능)
		
		//파일에 데이터 저장하기(쓰기)
		//1. 스트림 객체 생성하기(스트림 열기) - 빨대를 음료컵에 꽂기
		//2. 스트림 객체 사용하기(쓰기)
		//3. 스트림 객제 닫기(스트림 닫기) - 마무리 작업
