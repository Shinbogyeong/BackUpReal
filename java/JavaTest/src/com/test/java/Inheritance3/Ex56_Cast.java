...
public class Ex56_Cast {
	...
	public static void main(String[] args) {
		...
		//3. 각 브랜드 제품별 고유 기능도 점검(LG300.call(), HP400.selTest())
	...
	private static void m3() {
		...
		for (int i=0; i<list.length; i++ ) {
			...
			//추상메소드
			//공통기능 -> 추상메소드 -> 겉으로는 동일해보여도.. 실제로는 하는일 각각다르다.
			list[i].print();
			...
			// -2항 연산자
			// - 객체 instanceof 타입
			// - 앞의 객체를 뒤의 자료형으로 형변환이 가능합니까? -true, flase
...
abstract class Printer {
	...
	//추상 멤버
	// - 회사나 모델에 상광벗이 모든 프린터가 가져야할 공통적인 사용법
	// - 사용법은 동일해도.. 그 내부의 구현 내용을 각자가 알아서 구현하다.(***)
