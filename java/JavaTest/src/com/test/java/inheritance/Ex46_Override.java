...
public class Ex46_Override {
	...
	public static void main(String[] args) {
		...
		//com.test.question.inheritance.Time@19dfb7
		// - com.test.question.inheritance : 패키지.클래스명
		// - @
		// - 19dfb7 : 해시코드(HashCode) -> 해당 객체가 있는 메모리 주소값(Hex)
		
		//print(), ptrintln(), printf()
		// - 객체 변수를 출력하게 되면 자동으로 객체의 toString() 메소드를 호출하고 그 반환값을 출력한다.
		
		
		//info() 메소드를 사용안하고 toString을 재정의 하는 이유
		// -> 많은 사람들의 공통된 경험
		...
		System.out.println(d.toString()); //Date.toString() -> Date클래스가 재정의
