...
public class Ex45_Overriding {
	...
	public static void main(String[] args) {
		...
		//s1.dial();//물려받긴 했지만..사용하기엔 찜찜함.. 상황 > 상속을 거부할 수도 없음;
...
class SmartPhone extends Phone {
	...
	//****상속관계에서 부모가 물려준 메소드와 동일한 시그니처로 메소드를 선언하게 되면
	//	  자식의 메소드가 부모의 메소드보다 우선해서 노출괸다.(호출당하게 된다.)`
...
class BBB extends AAA {
	...
	public int a; //변수 오버라이드 -> 사용 안한 (100%) -> 의미 전혀 없음;;; 
