...
/**
 * 관리자 전용 게시판의 공지사항과 관련되어 있는 메뉴의 기능들을 담고있는 클래스입니다.
 * @author 3조
 *
 */
public class ManagerNotice {
   ...
   /**
    * 관리자 전용 게시판에서 이용할 수 있는 메뉴들을 보여주는 메서드입니다.
    */
   ...
   /**
    * 관리자 전용 게시판에서 새로 작성한 공지사항 게시글을 저장해주는 메서드입니다.
    */
   ...
   /**
    * 관리자 전용 공지사항 게시판에서 게시글을 삭제할 수 있는 메서드입니다.
    */
   ...
   /**
    * 관리자 전용 공지사항 게시판에서 게시글을 수정할 수 있는 메서드입니다.
    */
   ...
   /**
    * 하나의 공지사항 게시글을 선택하기 위해 필요한 게시글 번호를 부여하는 메서드입니다.
    * @param sel
    * @return
    */
   ...
   /**
    * 관리자 전용 공지 게시판에서 게시글을 등록할 수 있는 메서드입니다.
    */
   ...
   /**
    * 새롭게 작성하는 공지사항 글에 번호를 부여하는 메서드입니다.
    * 
    * @return
    */
