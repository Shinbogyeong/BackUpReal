...
/**
 * 전체 직원의 코로나설문조사 중 오늘날짜기준으로 
 * 설문조사에 이상이 있는 경우만 보여준다.
 * (코로나 감염을 예방하기 위한 설문조사, 오늘기준으로 이상이 없는 사람의 자가진단서는 출력하지 않는다)
 * @author 3조
 *
 */
...
public class CovidDocument {
	...
	/**
	 * 파일에 저장되어있는 직원들의 모든 자가진단서 목록을 불러와
	 * 오늘 설문한 직원을 대상으로 이상이있는 직원들의 자가진단서만 보여주는 메서드입니다. 
	 */
	...
	/**
	 * 직원들의 자가진단서 목록 중 자세히 확인 할 직원의 사원번호를 입력하면
	 * 해당 자가진단서를 불러와주는 메서드.
	 */
