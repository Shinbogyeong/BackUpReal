...
/**
 * 직원 스케줄을 관리하는 클래스입니다.
 * 직원들이 신청한 연차를 확인하고 결재 또는 반려를 해주는 클래스입니다.
 * 1. 신청된 연차 결재와 반려
 * 2. 캘린거 수정
 * @author 3조
 *
...
public class ManagerSchedule {
   ...
   /**
    * 관리자가 결재해야 할 연차목록과, 직원 스케줄캘린더를 수정할 수 있는 목록을 선택하는 메소드입니다.
    */
   ...
   /**
    *직원 스케줄 캘린더를 수정할 월을 선택할수 있는 메서드입니다.
    */
   ...
   /**
    * 날짜 별 연차사용직원 정보(연차종류, 연차사유)를 상세히 보여주는 메서드입니다.
    */
   ...
   /**
    * 선택한 직원의 연차를 스케줄 캘린더에서 삭제하는 메서드입니다.
    */
   ...
   /**
    * 선택한 직원의 연차를 스케줄 캘린더에서 추가하는 메서드입니다.
    * 연차 종류와 연차 사유를 입력하고 list2에 객체를 추가한다.
    */
   ...
   /**
    * 날짜 별 연차사용 직원의 연차 정보를 상세히 보여주는 메서드입니다.
    * @param selectEmployee
    */
