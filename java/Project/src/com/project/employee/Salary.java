...
/**
 * 직원들이 급여명세서를 확인하는 클래스입니다.
 * 직원들의 정보를 자동으로 불러와 지난달 근무에 대한 급여명세서를 제공해준다
 * @author 3조
 */
public class Salary {
	...
	/**
	 * 해당 사원의 정보를 불러와 
	 * 지난 달 급여명세서를 보여주는 메서드입니다.
	 * (기본급, 직책수당, 야간수당, 상여금 등 
	 * 급여명세서에 필요한 정보를 불러와 급여를 계산해준다)
	 */
	public void salary() {
	...
	/**
	 * 야간수당을 위한 메서드.
	 * 직원들의 출퇴근 시간을 불러와 야근한 횟수와 시간을 계산하여
	 * 야간수당을 측정해준다.
	 */
	...
	/**
	 * 식대를 위한 메서드
	 * 지난 달 근무 횟수를 불러와 근무한 일 수 만큼 식비를 제공해준다.
	 */
