...
/**
 * 직원들이 이용할 수 있는 익명게시판의 공지사항 메뉴에 대한 기능들이 담겨있는 클래스입니다.
 * @author 3조
 *
 */
public class EmployeeNotice {
   ...
   /**
    * 공지사항 게시글 더미데이터를 객체 배열에 저장해주는 메서드입니다.
    */
   ...
   /**
    * 직원 전용 익명게시판에서 공지사항 메뉴를 선택했을 때 공지사항 목록을 보여주는 메서드입니다.
    */
   ...
   /**
    * 직원 전용 익명게시판의 공지사항을 자세히 보기 위해 필요한 메서드 입니다.
    * @param seq
    * @return
    */
