...
select last + first from tblComedian; --ORA-01722: invalid number //더하기는 산술연산만 가능하다 숫자만 넣으라
...
-- 비교연산의 결과는 논리형인데.. 논리형이 없어서 결과셋에 담지를 못한다. (표현을 못한다.)
...
select name as "사용자 이름" from tblMen; --공백을 적을 수 없음 -- 사용하지 말것
select name as "select" from tblMen; -- 절대 사용하지 말것
