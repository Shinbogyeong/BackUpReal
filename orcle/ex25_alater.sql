...
alter table tblEdit
    add (description varchar2(100) default '임시' not null); -- not null 컬럼추가
...
--    constraint tbledit2_seq_pk primary key(seq),
--    constraint tbledit2_data_ck check(length(data) >= 5),
--    constraint tbledit2_pseq_fk foreign key(pseq) references tblEdit(seq)
);
