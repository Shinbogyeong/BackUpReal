...
6. default
    - 기본값 설정
    - 해당 컬럼값이 null이면 대신 미리 준비한 기본값을 대입힌다.
...
create table tblMemo(
    ...
    --color varchr2(30) not null check(color = 'red' or color 'blue' or color = 'yellow')
    lv number not null check(lv between 1 and 5),
    color varchr2(30) not null check(color in('red', 'blue', 'yellow')),
...
create table tblMemo(
    ...
    seq number(3) primary key, 
    name varchar2(30) default '익명', -- 중복값 금지, 식별자로는 사용할 수 없다.(null을 허용하기 때문에)
...
-- ORA-02290: check constraint (HR.SYS_C007070) violated
...
insert into tblMemo(seq, name, memo, regdate) values (1, '홍길', '메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.', sysdate);

insert into tblMemo(seq, name, memo, regdate) values (1, '홍길동홍길동홍길동', '메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.메모입니다.', sysdate);
